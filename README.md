...
* `aws_access_key_id`: *Optional.* AWS Access Key ID use with use_aws_iam_authenticator.
* `aws_secret_access_keyd`: *Optional.* AWS Access Key ID use with use_aws_iam_authenticator.
